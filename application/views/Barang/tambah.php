            ...
            <div class="card-body">
                <?= form_open('barang/simpan'); ?>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('kode_barang') ? 'is-invalid' : '' ?>" 
                               id="kode_barang" name="kode_barang" value="<?= set_value('kode_barang', $kode_barang) ?>" 
                               readonly>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('nama_barang') ? 'is-invalid' : '' ?>" 
                               id="nama_barang" name="nama_barang" value="<?= set_value('nama_barang') ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control <?= form_error('deskripsi') ? 'is-invalid' : '' ?>" 
                                  ...
                                  placeholder="Masukkan deskripsi barang"><?= set_value('deskripsi') ?></textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control <?= form_error('stok') ? 'is-invalid' : '' ?>" 
                               id="stok" name="stok" value="<?= set_value('stok', '0') ?>"
